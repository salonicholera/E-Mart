        ...
        <div class="row">
            <div class="col-md-12">
                <div class="success-text">
                    ...
                    <h2>thank you</h2>
                    <p>Your Order Places Successfully.</p>
                    <p class="font-weight-bold">Order ID:#00<?php echo e($order->id); ?></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="product-order">
                    ...
                    <div class="row product-order-detail">
                        ...
                        <div class="col-3 order_detail">
                            <div>
                                <h4>price</h4>
                                <h5>$<?php echo e($item->quantity * $item->product->price); ?></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="total-sec">
                        <ul>
                            <li>subtotal <span>$<?php echo e($order->total); ?></span></li>
                            <li>shipping <span>$00.00</span></li>
                        </ul>
                    </div>
                    <div class="final-total">
                        <h3>total <span>$<?php echo e($order->total); ?></span></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <ul class="order-detail">
                                <li>order ID: #00<?php echo e($order->id); ?></li>
                                <li>Order Date: <?php echo e($order->created_at); ?></li>
                        ...
                        <div class="col-sm-6">
                            ...
                            <ul class="order-detail">
                                <li><?php echo e(Auth::user()->address); ?> </li>
                                <li><?php echo e(Auth::user()->country); ?> <?php echo e(Auth::user()->state); ?>, <?php echo e(Auth::user()->postal_code); ?></li>
                                <li>Contact No. <?php echo e(Auth::user()->phone); ?></li>
                            </ul>
                        </div>
                        <div class="col-sm-12 payment-mode mt-5">
...
<?php echo $__env->make('store.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\chole\OneDrive\Desktop\8\resources\views/store/product/success.blade.php ENDPATH**/ ?>