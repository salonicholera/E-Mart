...
<section class="p-0 small-slider">
    <div class="slider-animate home-slider">
        <div>
            <div class="home">
                <img src="<?php echo e(asset('store/images/vegetables/banner/14.jpg')); ?>" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    ...
                                    <h1 class="animated" data-animation-in="fadeInUp" data-delay-in="0.3">
                                        vegetables</h1><a href="#" class="btn btn-solid animated"
        ...
        <div>
            <div class="home text-center">
                <img src="<?php echo e(asset('store/images/vegetables/banner/15.jpg')); ?>" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
...
<div class="container-fluid p-0-xl">
    ...
    <section class="service-w-bg banner-padding">
    ...
    <section class="addtocart_count ratio_square">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title1">
                    ...
                    <div class="five-product-slider product-m no-arrow">
            ...
            <div class="container">
                <div class="row partition3">
                    <div class="col-md-4">
                        <a href="<?php echo e(route('product')); ?>">
                            <div class="collection-banner p-right">
                                <div class="img-part bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/vegetables/banner/13.jpg&quot;); background-size: cover; background-position: center center; display: block;">
                                    <img src="<?php echo e(asset('store/images/vegetables/banner/13.jpg')); ?>" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                                </div>
                    ...
                    <div class="col-md-4">
                        <a href="<?php echo e(route('product')); ?>">
                            <div class="collection-banner p-right">
                                <div class="img-part bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/vegetables/banner/11.jpg&quot;); background-size: cover; background-position: center center; display: block;">
                                    <img src="<?php echo e(asset('store/images/vegetables/banner/11.jpg')); ?>" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                                </div>
                                <div class="contain-banner content-bg banner-3">
                                    <div>
                                        <h2>veggies</h2>
                    ...
                    <div class="col-md-4">
                        <a href="<?php echo e(route('product')); ?>">
                            <div class="collection-banner p-right">
                                <div class="img-part bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/vegetables/banner/12.jpg&quot;); background-size: cover; background-position: center center; display: block;">
                                    <img src="<?php echo e(asset('store/images/vegetables/banner/12.jpg')); ?>" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                                </div>
                                <div class="contain-banner content-bg banner-3">
                                    <div>
                                        <h2>bread</h2>
...
<?php echo $__env->make('store.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\chole\OneDrive\Desktop\8\resources\views/store/home/index.blade.php ENDPATH**/ ?>