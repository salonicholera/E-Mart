            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-slick">
                        <div>
                            <img src="{{ asset('upload/products') }}/{{ $product->image }}" alt="" class="img-fluid m-auto blur-up lazyload image_zoom_cls-0">
                        </div>
                    </div> 
                    <div class="row">
                        <div class="col-12 p-0">
                            <div class="slider-nav">
                                <div>
                                    <img src="{{ asset('upload/products') }}/{{ $product->image }}" alt="" class="img-fluid blur-up lazyload">
                                </div>
                            </div>
                        </div>
                    </div>
