        ...
        <div class="row">
            <div class="col-md-12">
                <div class="success-text">
                    ...
                    <p class="font-weight-bold">Order ID:#00{{$order->id}}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="product-order">
                    ...
                    <div class="total-sec">
                        <ul>
                            <li>subtotal <span>${{$order->total}}</span></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <ul class="order-detail">
                                ...
                                <li>{{ Auth::user()->country }} {{ Auth::user()->state }}, {{ Auth::user()->postal_code }}</li>
                                <li>Contact No. {{ Auth::user()->phone }}</li>
                            </ul>
                        </div>
